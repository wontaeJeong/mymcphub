# 74. Upgrade and Migration Tests
...
DB migration과 Helm upgrade 회귀 테스트를 추가한다.
...
1. migration up/down를 구현하거나 보강한다.
2. sample old data를 구현하거나 보강한다.
3. helm diff를 구현하거나 보강한다.
4. rollback check를 구현하거나 보강한다.
5. CI optional를 구현하거나 보강한다.
...
`docs/handoffs/74_UPGRADE_MIGRATION_TESTS.md` 파일을 만들고 다음을 기록한다.

```md
# 74. Upgrade and Migration Tests Handoff

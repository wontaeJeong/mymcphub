# 79. Multi-client Compatibility Matrix
...
opencode/Claude Code/Codex/IDE별 MCP remote 연결 호환성 매트릭스를 작성한다.
...
1. transport를 구현하거나 보강한다.
2. OAuth를 구현하거나 보강한다.
3. DCR를 구현하거나 보강한다.
4. token storage를 구현하거나 보강한다.
5. known limitations를 구현하거나 보강한다.
6. manual test checklist를 구현하거나 보강한다.
...
`docs/handoffs/79_MULTI_CLIENT_COMPAT_MATRIX.md` 파일을 만들고 다음을 기록한다.

```md
# 79. Multi-client Compatibility Matrix Handoff

...
로컬 개발용 seed data와 demo scenario를 만든다.
...
1. demo users/teams를 구현하거나 보강한다.
2. demo servers를 구현하거나 보강한다.
3. demo grants를 구현하거나 보강한다.
4. fake audit events를 구현하거나 보강한다.
5. reset command를 구현하거나 보강한다.
...
`docs/handoffs/70_LOCAL_DEV_SEED_DATA.md` 파일을 만들고 다음을 기록한다.

```md
# 70. Local Dev Seed Data Handoff

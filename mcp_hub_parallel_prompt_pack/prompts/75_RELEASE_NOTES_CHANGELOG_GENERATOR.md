# 75. Release Notes and Changelog Generator
...
변경사항을 lane/prompt 기준으로 수집해 changelog를 생성하는 스크립트를 만든다.
...
1. conventional commits optional를 구현하거나 보강한다.
2. prompt id mapping를 구현하거나 보강한다.
3. breaking changes를 구현하거나 보강한다.
4. security notes를 구현하거나 보강한다.
5. template를 구현하거나 보강한다.
...
- 릴리즈마다 기능/보안/마이그레이션 변경사항을 일관되게 정리할 수 있다.
...
`docs/handoffs/75_RELEASE_NOTES_CHANGELOG_GENERATOR.md` 파일을 만들고 다음을 기록한다.

```md
# 75. Release Notes and Changelog Generator Handoff

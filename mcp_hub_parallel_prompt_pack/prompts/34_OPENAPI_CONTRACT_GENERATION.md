# 34. OpenAPI Contract Generation
...
Control Plane API의 OpenAPI 생성, lint, client SDK 생성 구조를 구현한다.
...
1. OpenAPI source of truth를 구현하거나 보강한다.
2. lint를 구현하거나 보강한다.
3. generated TS client를 구현하거나 보강한다.
4. CI check를 구현하거나 보강한다.
5. docs link를 구현하거나 보강한다.
...
- API 변경 시 OpenAPI와 generated client가 일관되게 갱신된다.
...
`docs/handoffs/34_OPENAPI_CONTRACT_GENERATION.md` 파일을 만들고 다음을 기록한다.

```md
# 34. OpenAPI Contract Generation Handoff

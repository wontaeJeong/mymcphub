export function Badge({ value }: { value: string }) { const cls = value === "healthy" || value === "success" ? "healthy" : value === "offline" || value === "failed" ? "offline" : value === "degraded" ? "degraded" : ""; return <span className={`badge ${cls}`}>{value}</span>; }

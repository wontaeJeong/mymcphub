...
export default async function CatalogPage({ searchParams }: CatalogPageProps) {
  ...
  return (
    <div className="page-stack">
      <PageHero eyebrow="MCP 서버 카탈로그" title="신뢰할 서버를 빠르게 찾으세요." description="실시간 제어 플레인 카탈로그와 상태 엔드포인트에서 MCP 서버를 탐색, 필터링, 등록합니다." />
      <form className="form-card" action="/catalog">
        ...
        <div className="form-actions">
          ...
          <a className="button button--ghost" href="/catalog">초기화</a>
        </div>
      </form>
